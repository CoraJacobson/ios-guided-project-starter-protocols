...
// static refers to a class-level property (not an instance-level property)
...
class Dice {
    let sides: Int
    let generator: GeneratesRandomNumbers // can be anything that conforms to the GeneratesRandomNumbers protocol
